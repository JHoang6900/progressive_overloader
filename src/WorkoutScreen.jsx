...
function WorkoutInput({ value, onChange, placeholder, align = "left" }) {
  return (
    <input
      type="text" // Keep as text to allow "135+5" if wanted
      value={value}
              ...
              <div className="pt-4 mt-4 space-y-2 border-t border-zinc-800/50">
                {exercise.sets.map((set, setIndex) => {
                  ...
                  return (
                    ...
                    >
                      {/* ... All your Ghost Data and Input Row code stays EXACTLY the same here! ... */}
                      {/* --- GHOST HEADER ROW --- */}
                      {previousSet && (
                      ...
                      <div className="flex items-center justify-between h-8">
                        ...
                        <button
                          ...
                          className="p-4 ml-3 transition-colors rounded-md shrink-0 text-zinc-600 hover:text-rose-500 hover:bg-rose-500/10 group group-hover"
                        >
